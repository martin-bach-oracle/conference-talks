...
This repository contains code used in my conference talks since October 2024.. If you have questions or comments, please open an issue and mention the relevant branch.

## Overview

Instead of a "main" repository containing a subdirectory per presentation, you will now find a branch per conference talk. This approach simplifies things, especially when working with JavaScript and Python environments.

Each talk has its own branch containing the relevant code.. Main _won't_ contain code, it remains empty except for the readme (this file) and a license.

| Date | Event | Branch Name |
| --   | --    | --           |
| 11-OCT-2024 | POUG: Annual Meeting of the [Polish Oracle User Group](https://poug.org/en/edycja/poug2024/) | `241011_poug` |
